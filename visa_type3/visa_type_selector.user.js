...
async function runScript() {
  try {
    ...
    const options = [
      ['{{CITY}}', '2 Members'],      // Первый dropdown
      ['{{CITY}}', 'Schengen Visa','2 Members','Tourism'],  // Второй dropdown
      ['Schengen Visa', '2 Members','Tourism'], // Третий dropdown
      ['Schengen Visa', '2 Members','Tourism'], // Четвертый dropdown
