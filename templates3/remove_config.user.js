...
(function () {
    ...
    function redirectToAppointmentPage() {
        setTimeout(() => {
            window.location.href = 'https://appointment.blsspainrussia.ru/Global/Appointment/NewAppointment';
        }, 100);
    }
        ...
        for (const url of TEST_URLS) {
            try {
                ...
                if (res.ok) {
                    ...
                    setTimeout(() => {
                        window.location.href = 'https://appointment.blsspainrussia.ru/Global/account/Login?returnUrl=%2FGlobal%2Fappointment%2Fnewappointment&err';
                    }, 4000);
                    break;
                }
            } catch (e) {}
